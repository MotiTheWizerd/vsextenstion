...
import { WebhookServer, RayResponseHandler, CommandExecutor, ApiClient } from '.';
...
export class ExtensionManager {
    ...
    private setupRayResponseHandling(): void {
        ...
        setProcessRayResponseCallback(this.rayResponseHandler.processRayResponse.bind(this.rayResponseHandler));
    }
    ...
    private setupTreeView(): void {
        ...
        vscode.window.registerTreeDataProvider("rayDaemonDummyView", treeDataProvider);
    }
